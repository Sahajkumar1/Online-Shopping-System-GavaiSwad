...
public class ProductEntity{
	...
	public ProductEntity(Integer product_id, String product_name, String product_desc, Integer fk_cat_id,
			Integer fk_brand_id, Integer product_qty, Double product_cost_price, Integer product_rating,
			String product_image_sm, String product_image_lg, Double product_selling_price, Double product_weight,
